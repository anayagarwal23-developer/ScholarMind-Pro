...
// Start listener for non-Vercel/non-Serverless environments
if (process.env.VERCEL !== '1') {
  ...
  // On Vercel, we just need to attach the production serving routes
  // since Vercel handles the environment differently.
  setupProduction();
}
